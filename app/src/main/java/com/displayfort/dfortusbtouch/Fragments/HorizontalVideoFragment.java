 ...
 * DFortUSB
 */
public class HorizontalVideoFragment extends Fragment {
    private File files;
    ...
    public static HorizontalVideoFragment newInstance(Context context, File files) {
        mContext = context;
        HorizontalVideoFragment oneFragment = new HorizontalVideoFragment();
