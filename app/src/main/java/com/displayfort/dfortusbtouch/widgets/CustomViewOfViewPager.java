...
/**
 * Created by pc on 07/03/2019 16:51.
 * Dfortusbtouch
 */
...
public class CustomViewOfViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see CustomViewOfViewPager#SCROLL_STATE_IDLE
         * @see CustomViewOfViewPager#SCROLL_STATE_DRAGGING
         * @see CustomViewOfViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public CustomViewOfViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public CustomViewOfViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
