...
import com.displayfort.dfortusbtouch.Fragments.HorizontalVideoFragment;
...
import com.displayfort.dfortusbtouch.widgets.CustomViewOfViewPager;
 ...
 * MyApplication
 */
public class HorizontalAdsFromUsbActivity extends BaseSupportActivity {
    ...
    private int count = 1;
    private CustomViewOfViewPager customViewPager;
    ...
    private void setViewpagerAdaprter() {
        customViewPager.setAdapter(new ViewPagerAdapter(getSupportFragmentManager(),completFileList,HorizontalAdsFromUsbActivity.this));
        if (viewPager != null) {
                    ...
                    new CircularViewPager.GetFragmentItemListener() {
                        ...
                        public Fragment getFragment(int position) {
                            ...
                            if (type != null && type.toLowerCase().contains("video")) {
                                fragment = new HorizontalVideoFragment().newInstance(HorizontalAdsFromUsbActivity.this, files);
                            } else {
                                fragment = new ImageFragment().newInstance(HorizontalAdsFromUsbActivity.this, files);
                            }
